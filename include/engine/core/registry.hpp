...
public:
    ...
    ComponentStorage<Lifetime>& lifetimes()
    {
        return lifetimes_;
    }

    ComponentStorage<Sensor>& sensors()
    {
        return sensors_;
    }
    ...
    const ComponentStorage<Transform>& transforms() const
    {
        return transforms_;
    }

    const ComponentStorage<Renderable>& renderables() const
    {
        return renderables_;
    }
